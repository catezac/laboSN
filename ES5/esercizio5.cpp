...
int main() {
    ...
    WriteToFile_pos("OUTPUT/prob_GS_100.dat", M, x_GS);
    auto result_gs_unif = sum_prog(ave_GS, av2_GS, N);
    WriteToFile_r("OUTPUT/r_medio_GS_" + method + "_100.dat", N, result_gs_unif.first, ave_GS, result_gs_unif.second);
    ...
    WriteToFile_pos("OUTPUT/prob_2p_100.dat", M, x_2p);     
    auto result_2p = sum_prog(ave_2p, av2_2p, N);
    WriteToFile_r("OUTPUT/r_medio_2p_" + method + "_100.dat", N, result_2p.first, ave_2p, result_2p.second);
