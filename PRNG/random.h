...
public:
  ...
  // Method to generate a random number with a distribution 2-2x, for importance sampling
  double Imp_sampling();
  // genarator of a pass of the RW_discrete 3D
  //double Random :: RW3D_discrete(vector <double> x);
};
